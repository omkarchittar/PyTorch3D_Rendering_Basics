...
def render_cow(
    ...
    color=[0, 1, 0.9],
    device=None,
    output_file="images/360_cube_render.gif",
):
    if device is None:
        device = get_device()
    ...
    vertices = torch.tensor([[-0.5, -0.5, 0.5], [0.5, -0.5, 0.5], [0.5,  -0.5, -0.5], [-0.5, -0.5, -0.5],
                             [-0.5,  0.5, 0.5], [0.5,  0.5, 0.5], [0.5,   0.5, -0.5], [-0.5,  0.5, -0.5]])
    faces = torch.tensor([[0, 4, 1], [1, 4, 5], [1, 5, 2], [2, 5, 6], [2, 6, 3], [3, 6, 7], 
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_file", type=str, default="images/360_cube_render.gif")
